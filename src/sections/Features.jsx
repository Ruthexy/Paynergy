    ...
    <section id="features" className="py-20 lg:py-32 bg-green-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 opacity-0 animate-fade-up">
          <h2 className="font-sans font-bold text-3xl sm:text-4xl lg:text-5xl text-black mb-4">
            Everything You Need
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-off-white rounded-2xl p-8 h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="font-sans font-bold text-xl text-black mb-4">
                  {feature.title}
                </h3>
        ...
        {/* Security Badges */}
        <div
          className="mt-20 text-center opacity-0 animate-fade-up"
