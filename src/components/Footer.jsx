        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <svg className="h-10 w-10 text-electric-lime" viewBox="0 0 40 40" fill="currentColor">
            ...
            <p className="font-sans text-white/80 mb-6 max-w-md leading-relaxed">
              One Click. Every Bill. Paid. Simplify your utility payments with our 
              intelligent consolidation and autopay platform.
            </p>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-sans text-white/80">hello@paynergy.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <PhoneIcon className="w-5 h-5 text-electric-lime" />
                <span className="font-sans text-white/80">(555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPinIcon className="w-5 h-5 text-electric-lime" />
                <span className="font-sans text-white/80">San Francisco, CA</span>
              </div>
            </div>
          ...
          {/* Product Links */}
          <div>
            <h3 className="font-sans font-bold text-lg text-white mb-4">Product</h3>
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <button
                    onClick={() => scrollToSection(link.href)}
                    className="font-sans text-white/70 hover:text-electric-lime transition-colors"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-sans font-bold text-lg text-white mb-4">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-sans font-bold text-lg text-white mb-4">Legal</h3>
            <ul className="space-y-3">
